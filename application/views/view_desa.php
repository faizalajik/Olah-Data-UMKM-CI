  ...
  <body id="page-top">
    ...
    <section class="bg-primary" id="dataukm">
      <div class="container col-md-11 col-md-offset-0.5">
        <div class="card">
            <div class="card-body">
                <h2 class="text-center">Data Per Desa UKM</a></h2>
                <div class="form-group">
                </div>
             
                <br/>

                <form action="<?php echo base_url('index.php/home/getSortDesa'); ?>" method="GET" class="form-inline">
               <select name="tahun" class="form-control" >
                    ...
                    <option value="2021">2021</option>
                      ...
                      <select name="kecamatan" id="kategori" class="form-control">
                        ...
                        <?php endforeach;?>
                           ...
                           <select name="desa" class="subkategori form-control">
                                <option value="0">-PILIH-</option>
                              </select>
                ...
                <br>
                    <?php
                    foreach($des as $x)?>
                 <a style="margin-bottom:10px" href="<?php echo base_url('index.php/home/LaporanDesa?idd=').$x->id_desa; ?>" target="_blank" class="btn btn-primary ml-3"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
                <br>
                  ...
                  $no++; ?>
                    <tr>
                        ...
                        <td><?php echo $data->asset; ?></td>
                         <?php  if ($login == "anjaradmin"){ ?>
                        <td><a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='<?php echo base_url('index.php/home/getSortDesa?idd=').$data->id_desa; ?>' }" class="btn btn-danger">Hapus</a>
